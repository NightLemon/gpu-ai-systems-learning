...
> 你的后端工程经验在这里最有用——集群网络、存储、调度和排障。

| 文件 | 主题 | 要点 |
|------|------|------|
| [01-gpu-cluster-networking.md](01-gpu-cluster-networking.md) | 集群网络 | IB vs RoCE、拓扑映射、RoCE 故障排查、NCCL 调优 |
...
| [06-production-pitfalls.md](06-production-pitfalls.md) | 实战踩坑案例 | NGC 镜像版本、驱动/CUDA、CDI、MIG、RDMA、NCCL、Operator 升级 |
